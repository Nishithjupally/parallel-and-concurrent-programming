...
void testCS(int pid,MCSLock *MCS)
{
  ...
  //  QNode a,b;
    ...
    //	myPred = NULL;
    	...
    	fileoutput<<i+1<<" th CS Requested Entry at " <<print_time.substr(11,5)<< " by thread "<<pid+1<<" (mesg1)"<<endl;
        ...
        fileoutput<<i+1<<" th CS Exit at " <<print_time.substr(11,5)<< " by thread "<<pid+1<<" (mesg4)"<<endl;
